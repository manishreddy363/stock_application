...
from .views import stock_list, stock_analysis, stock_chart, correlation_analysis,get_variable_list,get_correlation_values,get_eq_values,page_3_api,get_data
