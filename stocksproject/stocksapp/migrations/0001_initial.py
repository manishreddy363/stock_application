# Generated by Django 4.2.4 on 2024-02-23 18:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Stock_Naics_Class_title', models.TextField(blank=True, max_length=250)),
                ('Stock_Naics_Superscript', models.CharField(blank=True, max_length=30)),
                ('Stock_Naics_Class_definition', models.TextField(blank=True, max_length=250)),
                ('Stock_Naics_symbol', models.CharField(blank=True, max_length=30)),
                ('Stock_Naics_StockID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stocksapp.stock_id', to_field='stock_id')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Stock_Historical_Data_V3_StockID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stocksapp.stock_id', to_field='stock_id')),
            ],
        ),
        migrations.CreateModel(
            name='stock_Earnings_4',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('Stock_Earnings_4_Surprise', models.FloatField(blank=True, default=None)),
                ('Stock_Earnings_4_Year', models.IntegerField(default=None)),
                ('Stock_Earnings_4_Fiscal_Quarter_End', models.CharField(default=None, max_length=30)),
                ...
                ('Stock_Earnings_4_Filing_Date', models.CharField(default=None, max_length=30)),
                ('Stock_Earnings_4_Filing_Date_2', models.CharField(default=None, max_length=30)),
                ('Stock_Earnings_4_Fiscal_Quarter_End_2', models.CharField(default=None, max_length=30)),
                ...
                ('Stock_Earnings_4_StockID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stocksapp.stock_id', to_field='stock_id')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Next_Filing_Dates_StockID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stocksapp.stock_id', to_field='stock_id')),
            ],
        ),
        migrations.CreateModel(
